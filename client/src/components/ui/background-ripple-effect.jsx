  ...
  return (
    <div
      ...
      className={cn(
        ...
        '[--cell-border-color:rgba(34,197,94,0.22)] [--cell-fill-color:rgba(0,0,0,0.55)] [--cell-shadow-color:rgba(34,197,94,0.20)]',
      )}
    >
      <div className="relative h-full w-full overflow-hidden">
        ...
        <DivGrid
          ...
          className={cn(
            'opacity-60',
            '[mask-image:radial-gradient(ellipse_at_top,rgba(0,0,0,1)_20%,rgba(0,0,0,0)_75%)]',
            '[-webkit-mask-image:radial-gradient(ellipse_at_top,rgba(0,0,0,1)_20%,rgba(0,0,0,0)_75%)]',
          )}
          rows={rows}
          cols={cols}
          cellSize={cellSize}
