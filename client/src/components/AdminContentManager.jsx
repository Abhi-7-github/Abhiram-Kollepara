...
export default function AdminContentManager({ skills, projects, onRefresh, forceShow = false }) {
  ...
  return (
    <div className="w-full">
      <div className="rounded-2xl border border-green-500/15 bg-black/40 p-5 sm:p-6">
        ...
        {error ? (
          <div className="mt-4 rounded-md border border-red-500/20 bg-red-500/10 p-3 text-xs text-red-200">{error}</div>
        ) : null}
